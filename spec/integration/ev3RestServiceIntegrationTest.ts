...
import EV3RestService = BinarisEV3.EV3RestService;
describe("Integration test suite with asynchronous HTTP Requests: ", function () {
    ...
    it("should perform a REAL http-Request to the 'run'-endpoint", function (done) {
        ev3RestService.run(10).then(function successCallback(response: any) {
    ...
    it("should perform a REAL http-Request to the 'rotation'-endpoint", function (done) {
        ev3RestService.rotate(45).then(function successCallback(response: any) {
    ...
    it("should perform a REAL http-Request to the 'rotation'-endpoint", function (done) {
        ev3RestService.buzz().then(function successCallback(response: any) {
    ...
    it("should perform a REAL http-Request to the 'rotation'-endpoint", function (done) {
        ev3RestService.beep().then(function successCallback(response: any) {
